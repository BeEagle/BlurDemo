...
#define CLASS_NAME "com/anarchy/blurdemo/blur/FastBlur"
...
JNIEXPORT void JNICALL Java_com_anarchy_blurdemo_blur_FastBlur_fastBlurJni(JNIEnv* env, jclass class, jobject bitmapIn, jobject bitmapOut, jint radius){
...
//   {"fastBlurJni","(Ljava/lang/Object;Ljava/lang/Object;I)V",jni_fast_blur}
//};
//
